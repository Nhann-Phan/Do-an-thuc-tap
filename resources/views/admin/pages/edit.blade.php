...
<div class="bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="{{ route('pages.update', $page->id) }}" method="POST">
        @csrf
        @method('PUT') {{-- Quan trọng: Method PUT để update --}}
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ $page->title }}" 
                           class="w-full border border-gray-300 p-3 rounded focus:outline-none focus:border-blue-500 shadow-sm" 
                ...
                <div>
                    ...
                    <div class="flex bg-gray-50 border border-gray-300 rounded overflow-hidden">
                        ...
                        <input type="text" name="slug" id="slug" value="{{ $page->slug }}" 
                               class="w-full p-3 bg-transparent focus:outline-none text-blue-600 font-medium">
                    </div>
                </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                {{-- 1. BOX LIÊN KẾT SECTIONS (TÍNH NĂNG LEVEL 3) --}}
                <div class="bg-purple-50 p-5 rounded-lg border border-purple-200 shadow-sm">
                    ...
                    <p class="text-sm text-purple-600 mb-4 leading-relaxed">
                        Quản lý các khối động như: Thống kê số liệu, Hình ảnh trái/phải, Nút kêu gọi hành động (CTA)...
                    </p>
                ...
                <div class="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <textarea name="summary" rows="5" class="w-full border border-gray-300 p-3 rounded text-sm focus:border-blue-500 focus:outline-none" placeholder="Đoạn văn ngắn hiển thị đầu trang...">{{ $page->summary }}</textarea>
                </div>
