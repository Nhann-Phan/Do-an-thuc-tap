...
@section('content')
    <div class="mb-6 flex items-center gap-3">
        ...
        <h3 class="font-bold text-gray-700 text-xl">Thêm Tài Khoản Mới</h3>
    </div>

    <form action="{{ route('admin.accounts.store') }}" method="POST" class="max-w-3xl bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
            ...
            <div>
                ...
                <input type="email" name="email" value="{{ old('email') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
            ...
            <div>
                ...
                <input type="text" name="phone" value="{{ old('phone') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
